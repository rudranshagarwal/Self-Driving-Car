...
if __name__ == "__main__":
    ...
    delete(server + cse + "Team-24", data_format="json")
    create_ae(server + cse, "Team-24","team24")
    create_cnt(server + cse + "Team-24/","Node-1", "team24")
    create_cnt(server + cse + "Team-24/Node-1/", "Data", "team24")
    create_data_cin(server + cse + "Team-24/Node-1/Data/", "[x y time]","team24")
